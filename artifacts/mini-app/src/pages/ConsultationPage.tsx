...
export function ConsultationPage({ onConfirm, onBack }: Props) {
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <div style={{ padding: "12px 16px 24px", borderTop: "1px solid var(--tg-border)" }}>
        <button onClick={onConfirm} style={{ width: "100%", background: "linear-gradient(135deg,#4CAF84,#2E7D52)", color: "#fff", border: "none", borderRadius: 14, padding: "15px 0", fontSize: 16, fontWeight: 700, cursor: "pointer" }}>
