...
const FUQ: Record<string, CourtEntry[]> = {
  ...
  buhvil: [
    { name: "Buxoro viloyat sudi",          address: "Buxoro shahri, Yangihayot ko'chasi, 122-uy",                phone: "+998 (65) 220-01-14, 80111", email: "f.buxoro@sud.uz",     jadval: "jadval2.sud.uz" },
    ...
    { name: "G'ijduvon tumanlararo sudi",   address: "G'ijduvon tumani, Yu.Hamadoniy ko'chasi, 54-uy",          phone: "+998 (65) 220-05-97, 81102", email: "f.gijduvon@sud.uz",   jadval: "jadval2.sud.uz" },
  ...
  jizzvil: [
    ...
    { name: "Paxtakor tumanlararo sudi",     address: "Paxtakor tumani, Yunus Rajabiy ko'chasi, 1-uy",                  phone: "+998 (55) 152-05-64, 25507", email: "m.paxtakor@sud.uz",    jadval: "jadval2.sud.uz" },
    ...
    { name: "Forish tumanlararo sudi",      address: "Forish tumani, Oqtepa KFY, Tutak qishlog'i",                     phone: "+998 (55) 152-05-73, 25561", email: "f.forish@sud.uz",      jadval: "jadval2.sud.uz" },
  ],
  kashvil: [
    ...
    { name: "Chiroqchi tumanlararo sudi",    address: "Chiroqchi tumani, Choshtepa MFY, Dam 2 massivi, 1-uy",          phone: "+998 (55) 404-69-31, 706210", email: "f.chiroqchi@sud.uz",  jadval: "jadval2.sud.uz" },
  ...
  qrvil: [
    ...
    { name: "Amudaryo tumanlararo sudi",           address: "Amudaryo tumani, Mang'it shahar, «Do'stlik» MFY, Gurlan ko'chasi",        phone: "+998 (55) 102-40-32, 95106", email: "f.amudaryo@sud.uz", jadval: "jadval2.sud.uz" },
  ...
  navvil: [
    ...
    { name: "Uchquduq tumanlararo sudi",     address: "Uchquduq tumani, A.Temur ko'chasi, 46-uy",                      phone: "+998 (79) 222-01-44, 85472", email: "f.uchquduq@sud.uz",   jadval: "jadval2.sud.uz" },
    { name: "Xatirchi tumanlararo sudi",    address: "Xatirchi tumani, Yangrabad qo'rg'oni, Pulkan ko'chasi, 60-uy",  phone: "+998 (79) 222-02-36, 85503", email: "f.xatirchi@sud.uz",   jadval: "jadval2.sud.uz" },
  ],
  namvil: [
  ...
  sirvil: [
    { name: "Sirdaryo viloyat sudi",      address: "Guliston shahar, Islom Karimov ko'chasi, 75-uy",              phone: "+998 (55) 651-75-00, 20011", email: "f.sirdaryo@sud.uz",   jadval: "jadval2.sud.uz" },
    { name: "Guliston tumanlararo sudi", address: "Sirdaryo viloyati, Guliston shahar, I.Karimov ko'chasi, 1-uy", phone: "+998 (55) 651-35-52, 20177", email: "f.guliston@sud.uz",   jadval: "jadval2.sud.uz" },
    { name: "Boyovut tumanlararo sudi",   address: "Boyovut shaharchasi, Tinchlik ko'chasi, 26-uy",                phone: "+998 (55) 651-35-45, 20062", email: "f.boyovut@sud.uz",    jadval: "jadval2.sud.uz" },
    ...
    { name: "Sirdaryo tumanlararo sudi",  address: "Sirdaryo shahar, Zavqbash ko'chasi, 1A-uy",                   phone: "+998 (55) 651-35-57, 20419", email: "f.sirdaryo.t@sud.uz", jadval: "jadval2.sud.uz" },
  ],
  xorvil: [
  ...
  farvil: [
    ...
    { name: "So'x tumanlararo sudi",          address: "So'x tumani, Ravon MFY, A.Temur ko'chasi, 187-uy",             phone: "+998 (73) 249-15-26, 40752", email: "f.sux@sud.uz",         jadval: "jadval2.sud.uz" },
  ...
  tashsh: [
    ...
    { name: "Mirobod tumanlararo sudi",          address: "Toshkent shahar, Mirobod ko'chasi, 19",                          phone: "+998 (71) 256-32-18",        email: "f.mirobod@sud.uz",        jadval: "jadval2.sud.uz" },
  ...
  surxvil: [
    { name: "Surxondaryo viloyat sudi",         address: "Termiz shahri, Sulton Saodat ko'chasi, 286B-uy",                        phone: "+998 (76) 228-19-00, 75062", email: "f.surxondaryo@sud.uz", jadval: "jadval2.sud.uz" },
    ...
    { name: "Boysun tumanlararo sudi",          address: "Boysun tumani, Olmazor ko'chasi",                                      phone: "+998 (76) 453-20-06, 75112", email: "f.boysun@sud.uz",      jadval: "jadval2.sud.uz" },
    ...
    { name: "Sariosiyo tumanlararo sudi",       address: "Sariosiyo tumani, Mehrshavqat mahallasi, Yorug' kun ko'chasi",          phone: "+998 (76) 453-20-03, 75462", email: "f.sariosiyo@sud.uz",   jadval: "jadval2.sud.uz" },
  ...
  samvil: [
    ...
    { name: "Pastdarg'om tumanlararo sudi",     address: "Pastdarg'om tumani, Obod mahallasi",                                phone: "+998 (55) 706-70-34, 30827", email: "f.pastdargom@sud.uz",   jadval: "jadval2.sud.uz" },
    { name: "Nurobod tumanlararo sudi",        address: "Nurobod shahri, A.Temur ko'chasi, 14-uy",                           phone: "+998 (55) 706-70-32, 30828", email: "f.nurobod@sud.uz",      jadval: "jadval2.sud.uz" },
    { name: "Urgut tumanlararo sudi",          address: "Urgut shahar, Navoiyshox ko'chasi, 98-uy",                          phone: "+998 (55) 706-70-36, 30829", email: "f.urgut@sud.uz",        jadval: "jadval2.sud.uz" },
  ],
};
