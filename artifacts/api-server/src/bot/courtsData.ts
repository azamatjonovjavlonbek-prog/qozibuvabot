...
const JIN: Record<string, CourtEntry[]> = {
  ...
  qrvil: [
    ...
    { name: "Jinoyat ishlar bo'yicha Qo'ng'irot tuman sudi",  address: "Qo'ng'irot tuman, O'zbekiston ko'chasi, 77A-uy",                            phone: "+998 55 102-40-38", email: "j.qungirot@sud.uz",    lat: 43.075700, lng: 58.900100 },
