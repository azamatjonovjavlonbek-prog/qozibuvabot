...
const FUQ: Record<string, CourtEntry[]> = {
  ...
  kashvil: [
    ...
    { name: "Chiroqchi tumanlararo sudi",    address: "Chiroqchi tumani, Choshtepа MFY, Dam 2 massivi, 1-uy",          phone: "+998 (55) 404-69-31, 706210", email: "f.chiroqchi@sud.uz",  jadval: "jadval2.sud.uz" },
